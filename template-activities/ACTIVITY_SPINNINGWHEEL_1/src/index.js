...
ACTIVITY_SPINNINGWHEEL_1.SpinningWheelLayer = HDBaseLayer.extend({
  ...
  onEnter: function () {
    ...
    cc.loader.loadJson("res/Activity/" + activityName + "/config.json", function (error, config) {
      ...
      ACTIVITY_SPINNINGWHEEL_1.ref.isCountingEnabled =
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.gameInfo.isCounting;
      ACTIVITY_SPINNINGWHEEL_1.ref.isStudentInteractionEnable = ACTIVITY_SPINNINGWHEEL_1.ref.isTeacherView
        ? true
        : false;
      ref.setupUI();
      ref.loadAudio();
      ...
      ACTIVITY_SPINNINGWHEEL_1.ref.config.teacherScripts.data.moduleStart.enable &&
        ref.triggerScript(ACTIVITY_SPINNINGWHEEL_1.ref.config.teacherScripts.data.moduleStart);
      ACTIVITY_SPINNINGWHEEL_1.ref.config.teacherTips.data.moduleStart.enable &&
  ...
  setupUI: function () {
    this.setBackground(
      ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath +
        ACTIVITY_SPINNINGWHEEL_1.ref.config.background.sections.background.imageName
    );
    this.baseLayer = this.createColourLayer(
      cc.color(0, 0, 0, 0),
      cc.winSize.width,
      cc.winSize.height,
      cc.p(0, 0),
  ...
  loadAudio: function () {
    cc.loader.load(
      ACTIVITY_SPINNINGWHEEL_1.ref.soundPath + ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.tapHiddenObject.sound
    );
  },
  ...
  loadSpriteFrames: function () {
    HDUtility.addSpriteFrames(
      ACTIVITY_SPINNINGWHEEL_1.ref.animationBasePath + "Win/object_pulled_out_animation_",
      ACTIVITY_SPINNINGWHEEL_1.ref.config.resources.animationFrames.animation[0].frameCount,
      "object_pulled_out_animation_",
      ".png"
    );
    HDUtility.addSpriteFrames(
      ACTIVITY_SPINNINGWHEEL_1.ref.animationBasePath + "Loss/object_pulled_out_animation_",
      ACTIVITY_SPINNINGWHEEL_1.ref.config.resources.animationFrames.animation[1].frameCount,
      "object_pulled_out_animation_",
      ".png"
    );
  },
  ...
  setupTarget: function () {
    ...
    if (targetBaseObject.imageName.length > 0) {
      var targetPosition = ACTIVITY_SPINNINGWHEEL_1.ref.isTeacherView
        ? targetBaseObject.position
        : cc.p(cc.winSize.width * 0.7, cc.winSize.height * 0.75);
      targetSprite = this.addSprite(
        ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + targetBaseObject.imageName,
        targetPosition,
        this
      );
      ...
      var targetPosition = ACTIVITY_SPINNINGWHEEL_1.ref.isTeacherView
        ? cc.p(
            ...
            cc.winSize.height * 0.85 - targetSprite.getContentSize().height * targetBaseObject.scale
          )
        : cc.p(
            cc.winSize.width * 0.6,
            cc.winSize.height * 0.75 - targetSprite.getContentSize().height * targetBaseObject.scale
          );
      targetSprite.setPosition(targetPosition);
      targetSprite.setScale(targetBaseObject.scale);
      targetSprite.setAnchorPoint(0.5);
    } else {
      targetSprite = this.createColourLayer(
        cc.color(
          targetBaseObject.backgroundColor.r,
          targetBaseObject.backgroundColor.g,
          targetBaseObject.backgroundColor.b,
          targetBaseObject.backgroundColor.a
        ),
        targetBaseObject.size.width,
        targetBaseObject.size.height,
        targetBaseObject.position,
        this,
        1
      );
    ...
    var targetImage = this.addSprite(
      "res/LessonResources/emptyImage.png",
      cc.p(targetSprite.getContentSize().width * 0.5, targetSprite.getContentSize().height * 0.5),
      targetSprite
    );
    ...
    if (ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselAssets.data[0].nameImage) {
      targetName = this.createTTFLabel(
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselAssets.data[0].nameImageName,
        cc.p(targetSprite.getContentSize().width * 0.5, targetSprite.getContentSize().height * 0.7),
        targetSprite
      );
      ...
      targetName = this.createTTFLabel(
        ...
        70,
        cc.p(0, 0, 0, 255),
        cc.p(targetSprite.getContentSize().width * 0.5, targetSprite.getContentSize().height * 0.69),
        targetSprite
      );
    }
  ...
  setupOptionButtons: function () {
    ...
    goButton = this.createButton(
      ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + goButtonObject.enableState,
      ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + goButtonObject.pushedState,
      "",
      32,
      ACTIVITY_SPINNINGWHEEL_1.Tag.goButton,
      goButtonObject.position,
      this,
      this,
      ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + goButtonObject.disableState
    );
    goButton.setScale(goButtonObject.scale);
    var targetBase = this.getChildByTag(ACTIVITY_SPINNINGWHEEL_1.Tag.targetBase);
    var goPosition = cc.p(
      targetBase.getPositionX() + goButton.getContentSize().width * 0.5 * goButton.getScale(),
      targetBase.getPositionY() - 20
    );
    ...
    var stopButton = this.createButton(
      ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + stopButtonObject.enableState,
      ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + stopButtonObject.pushedState,
      "",
      32,
      ACTIVITY_SPINNINGWHEEL_1.Tag.stopButton,
      stopButtonObject.position,
      this,
      this,
      ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + stopButtonObject.disableState
    );
  ...
  setupTargetImage: function () {
    ...
    if (
      !ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselAssets.data[
        ACTIVITY_SPINNINGWHEEL_1.ref.currentTargetIndex
      ].imageName
    ) {
      return;
    }
  ...
  setupSpinningWheel: function () {
    ...
    var position = ACTIVITY_SPINNINGWHEEL_1.ref.isTeacherView
      ? spinningWheelBaseObject.position
      : cc.p(cc.winSize.width * 0.3, cc.winSize.height * 0.5);

    var spinningWheelBase = this.addSprite(
      ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + spinningWheelBaseObject.imageName,
      position,
      this
    );
    ...
    var spinningWheelCenter = this.addSprite(
      ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + spinningWheelCenterObject.imageName,
      cc.p(spinningWheelBase.getContentSize().width * 0.5, spinningWheelBase.getContentSize().height * 0.5),
      spinningWheelBase
    );
    spinningWheelCenter.setScale(spinningWheelCenterObject.scale);

    var topPosition = cc.p(
      spinningWheelBase.getPositionX(),
      spinningWheelBase.getPositionY() + spinningWheelBase.getContentSize().height * spinningWheelBaseObject.scale * 0.5
    );
    var spinningWheelTop = this.addSprite(
      ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + spinningWheelTopObject.imageName,
      topPosition,
      this
    );
  ...
  setWheelObject: function (baseSprite) {
    ...
    for (let index = 0; index < wheelItems.length; index++) {
      ...
      var wheelItemSprite = this.addSprite(
        ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath + currentWheelItem.imageName,
        position,
        baseSprite
      );
      ...
      wheelItemSprite.setRotation(
        -this.getAngle(ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselAssets.data.length, index)
      );
    }
  },
  /**
  ...
  getItemPositionOnWheel: function (currentIndex, totalItems, baseSprite) {
    ...
    return cc.p(
      baseSprite.getContentSize().width * arrayXFactor[currentIndex],
      baseSprite.getContentSize().height * arrayYFactor[currentIndex]
    );
  },
  /**
  ...
  checkIfGoButtonEnabled: function () {
    if (
      ACTIVITY_SPINNINGWHEEL_1.ref.joinedStudentList.users &&
      ACTIVITY_SPINNINGWHEEL_1.ref.stopWheelUsers &&
      ACTIVITY_SPINNINGWHEEL_1.ref.joinedStudentList.users.length == ACTIVITY_SPINNINGWHEEL_1.ref.stopWheelUsers.length
    ) {
  ...
  updateStudentTurn: function (userName) {
    ...
    if (ACTIVITY_SPINNINGWHEEL_1.ref.isTeacherView) {
      if (!userName) {
        ...
        ACTIVITY_SPINNINGWHEEL_1.ref.config.teacherScripts.data.onMouseEnable.enable &&
          ACTIVITY_SPINNINGWHEEL_1.ref.triggerScript(
            ACTIVITY_SPINNINGWHEEL_1.ref.config.teacherScripts.data.onMouseEnable
          );
      }
    }
  },
  ...
  emitSocketEvent: function (type, data) {
    SocketManager.emitCutomEvent(
      ACTIVITY_SPINNINGWHEEL_1.socketEventKey.singleEvent,
      {
        eventType: type,
        roomId: HDAppManager.roomId,
        data: data,
  ...
  rotateWheel: function () {
    ...
    ACTIVITY_SPINNINGWHEEL_1.ref.config.teacherScripts.data.onGoButton.enable &&
    ...
    if (ACTIVITY_SPINNINGWHEEL_1.ref.tableView) ACTIVITY_SPINNINGWHEEL_1.ref.tableView.setTouchEnabled(false);
  },
  ...
  stopRotation: function () {
    ...
    if (!ACTIVITY_SPINNINGWHEEL_1.ref.isRotating)
      //If wheel is not rotating then there is not need to stop the wheel
      return;
  ...
  update: function (delta) {
    if (ACTIVITY_SPINNINGWHEEL_1.ref.isRotating) {
      ...
      if (ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.spinningWheelSpeed.currentValue < 3) {
        var selectedItemAngle = ACTIVITY_SPINNINGWHEEL_1.ref.getAngle(
          ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselAssets.data.length,
          ACTIVITY_SPINNINGWHEEL_1.ref.cardQueue[0]
        );
  ...
  completionAnimation: function (isCorrectAnswer) {
    let completionAnimation = cc.callFunc(function () {
      ...
      var animationSprite = new cc.Sprite(
        ACTIVITY_SPINNINGWHEEL_1.ref.animationBasePath + "Win/object_pulled_out_animation_0001.png"
      );
      if (isCorrectAnswer) {
        var animation = HDUtility.runFrameAnimation(
          ACTIVITY_SPINNINGWHEEL_1.ref.animationBasePath + "Win/object_pulled_out_animation_",
          ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.win.frameCount,
          0.1,
          ".png",
          1
        );
        animationSprite.setPosition(
          cc.p(
            ACTIVITY_SPINNINGWHEEL_1.ref.getContentSize().width * 0.5,
            ACTIVITY_SPINNINGWHEEL_1.ref.getContentSize().height * 0.5
          )
        );
      ...
      cc.audioEngine.playEffect(
        ACTIVITY_SPINNINGWHEEL_1.ref.soundPath +
          ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.tapHiddenObject.sound
      );
    });
    ...
    let updateTarget = cc.callFunc(function () {
      ...
      if (ACTIVITY_SPINNINGWHEEL_1.ref.isStudentInteractionEnable && !ACTIVITY_SPINNINGWHEEL_1.ref.isTeacherView) {
        ACTIVITY_SPINNINGWHEEL_1.ref.emitSocketEvent(HDSocketEventType.SWITCH_TURN_BY_STUDENT, {
          roomId: HDAppManager.roomId,
        });
      }
      if (!ACTIVITY_SPINNINGWHEEL_1.ref.isTeacherView) {
    ...
    var animationSprite = ACTIVITY_SPINNINGWHEEL_1.ref.baseLayer.getChildByTag(
      ACTIVITY_SPINNINGWHEEL_1.Tag.animationSprite
    );
    animationSprite.runAction(cc.sequence([completionAnimation, cc.delayTime(10), updateTarget]));

    if (ACTIVITY_SPINNINGWHEEL_1.ref.tableView) ACTIVITY_SPINNINGWHEEL_1.ref.tableView.setTouchEnabled(true);
  },
  ...
  setupNextTarget: function () {
    if (
      ACTIVITY_SPINNINGWHEEL_1.ref.currentTargetIndex + 1 >=
      ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselAssets.data.length
    ) {
  ...
  setCardContent: function () {
    ...
    let baseColorLayer = this.createColourLayer(
      cc.color(
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBackground.color.r,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBackground.color.g,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBackground.color.b,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBackground.color.a
      ),
      width,
      this.carouselHeight,
      position,
    ...
    if (ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBackgroundImage.imageName != "") {
      let carouselBaseImage = this.addSprite(
        ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath +
          ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBackgroundImage.imageName,
      ...
      let carouselBorderImage = this.addSprite(
        ACTIVITY_SPINNINGWHEEL_1.ref.spriteBasePath +
          ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBackgroundBorderImage.imageName,
        cc.p(position.x - 10, position.y),
        this
      );
  ...
  getWidthOfCarousel: function () {
    let cellWidthSize =
      this.carouselHeight * ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselAssets.data.length;
  ...
  tableCellAtIndex: function (table, idx) {
    ...
    cardCell.createUI(
      idx,
      ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselAssets.data[idx],
      cardCell,
      this.isCellSelected(idx)
    );
    return cardCell;
  },
    ...
    let completedAnimation = cc.callFunc(function () {
      if (ACTIVITY_SPINNINGWHEEL_1.ref.isCellSelected(cell.tag)) {
        ...
        if (ACTIVITY_SPINNINGWHEEL_1.ref.cardQueue) {
          lastIndex =
            ACTIVITY_SPINNINGWHEEL_1.ref.cardQueue.length == 0 ? -1 : ACTIVITY_SPINNINGWHEEL_1.ref.cardQueue[0];
        }
  ...
  getIndexOfCurrentElement: function (data) {
    for (
      var index = 0;
      index < ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselAssets.data.length;
      index++
    ) {
  ...
  mouseControlEnable: function (location) {
    if (
      ACTIVITY_SPINNINGWHEEL_1.ref.tableView &&
      cc.rectContainsPoint(ACTIVITY_SPINNINGWHEEL_1.ref.tableView.getBoundingBox(), location)
    ) {
      return true;
    }
...
ACTIVITY_SPINNINGWHEEL_1.HDCardCell = cc.TableViewCell.extend({
  ...
  createUI: function (idx, data, parent, isSelected) {
    ...
    let colourLayer = new cc.LayerColor(
      cc.color(
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxBackground.color.r,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxBackground.color.g,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxBackground.color.b,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxBackground.color.a
      ),
      this._contentSize.width - this.cellHorizontalPadding,
      this._contentSize.height - this.cellVerticalPadding
    );
    ...
    let textBaseLayer = new cc.LayerColor(
      cc.color(
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxCardBackground.color.r,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxCardBackground.color.g,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxCardBackground.color.b,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxCardBackground.color.a
      ),
      this._contentSize.width - this.cellHorizontalPadding,
      this.cardTextHeight
    );
    ...
    let labelCardText = cc.LabelTTF.create(
      data.label,
      ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxCardText.font,
      ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxCardText.fontSize,
      cc.size(0, 0),
    ...
    labelCardText.setColor(
      cc.color(
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxCardText.color.r,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxCardText.color.g,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxCardText.color.b,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxCardText.color.a
      )
    );

    this.highlightLayer = new cc.LayerColor(
      cc.color(
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxHighlight.color.r,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxHighlight.color.g,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxHighlight.color.b,
        ACTIVITY_SPINNINGWHEEL_1.ref.config.assets.sections.carouselBoxHighlight.color.a
      ),
