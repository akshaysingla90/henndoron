...
ACTIVITY_SAVE_A_SITUATION.SaveASituation = HDBaseLayer.extend({
    ...
    addBottomSideBar() {
        ...
        if (this.lastSavedState && this.lastSavedState.selectedIndex != -1 && this.isStudentInteractionEnable) {
            this.allowStudentTouch(data = {
                ...
                "broadcast": ACTIVITY_SAVE_A_SITUATION.BroadcastType.TO_SELF
            });
        }
    ...
    tableCellTouched: function (table, cell) {
        if (ACTIVITY_SAVE_A_SITUATION.ref.isTeacherView && cell.isTouchEnabled()) {
            ...
            ACTIVITY_SAVE_A_SITUATION.ref.emitSocketEvent(HDSocketEventType.GAME_MESSAGE, {
                'eventType': ACTIVITY_SAVE_A_SITUATION.socketEvents.ACTIVATE_CELL,
                'data': {
                    "userName": HDAppManager.username,
                    "index": cell.getTag(),
                    "broadcast": ACTIVITY_SAVE_A_SITUATION.BroadcastType.TO_EVERYONE_EXCEPT_SELF
                }
            });
        }
    ...
    checkOverlap: function (eventLocation, isDemo) {
        for (let index = 0; index < this.holesArray.length; index++) {
            ...
            if (cc.rectContainsPoint(this.holesArray[index].getBoundingBoxToWorld(), eventLocation) && this.holesArray[index].getName() == this.selectedObject.getName() && (this.isStudentInteractionEnable || this.isTeacherView) && !this.holesArray[index].isVisible()) {
                ...
                ACTIVITY_SAVE_A_SITUATION.ref.emitSocketEvent(HDSocketEventType.GAME_MESSAGE, {
                    'eventType': ACTIVITY_SAVE_A_SITUATION.socketEvents.PLUG_PLACED_AT_DESTINATION,
    ...
    onMouseMove: function (event) {
        if (ACTIVITY_SAVE_A_SITUATION.ref.isMouseDown && ACTIVITY_SAVE_A_SITUATION.ref.selectedCellIdx != -1 && (ACTIVITY_SAVE_A_SITUATION.ref.isTeacherView || (!ACTIVITY_SAVE_A_SITUATION.ref.isTeacherView && ACTIVITY_SAVE_A_SITUATION.ref.isStudentInteractionEnable))) {
            ...
            ACTIVITY_SAVE_A_SITUATION.ref.emitSocketEvent(HDSocketEventType.GAME_MESSAGE, {
                'eventType': ACTIVITY_SAVE_A_SITUATION.socketEvents.MOVE_PLUG,
                'data': {
                    "position": event.getLocation(),
                    "cellNo": ACTIVITY_SAVE_A_SITUATION.ref.currentCell.getTag(),
                    "userName": HDAppManager.username,
                    "broadcast": ACTIVITY_SAVE_A_SITUATION.BroadcastType.TO_EVERYONE_EXCEPT_SELF,
                    "isDemo": this.isTeacherView
                }
            });
            ACTIVITY_SAVE_A_SITUATION.ref.movePlug(data = {
                "position": event.getLocation(),
                "cellNo": ACTIVITY_SAVE_A_SITUATION.ref.currentCell.getTag(),
                "userName": HDAppManager.username,
                "broadcast": ACTIVITY_SAVE_A_SITUATION.BroadcastType.TO_SELF,
    ...
    onMouseUp: function (event) {
        if (ACTIVITY_SAVE_A_SITUATION.ref.isDragging && ACTIVITY_SAVE_A_SITUATION.ref.selectedObject.isVisible()) {
            ACTIVITY_SAVE_A_SITUATION.ref.placePlugBack(data = {
                "position": ACTIVITY_SAVE_A_SITUATION.ref.currentCell.convertToWorldSpaceAR(ACTIVITY_SAVE_A_SITUATION.ref.currentCell.cardElement.getPosition()),
                "userName": HDAppManager.username,
                "broadcast": ACTIVITY_SAVE_A_SITUATION.BroadcastType.TO_SELF,
                "cellIndex": this.selectedCellIdx
            });
            ACTIVITY_SAVE_A_SITUATION.ref.emitSocketEvent(HDSocketEventType.GAME_MESSAGE, {
                'eventType': ACTIVITY_SAVE_A_SITUATION.socketEvents.PLACE_PLUG_BACK,
                'data': {
                    "position": ACTIVITY_SAVE_A_SITUATION.ref.currentCell.convertToWorldSpaceAR(ACTIVITY_SAVE_A_SITUATION.ref.currentCell.cardElement.getPosition()),
                    "userName": HDAppManager.username,
                    "broadcast": ACTIVITY_SAVE_A_SITUATION.BroadcastType.TO_EVERYONE_EXCEPT_SELF,
    ...
    emitSocketEvent: function (type, data) {
        SocketManager.emitCutomEvent(ACTIVITY_SAVE_A_SITUATION.socketEventKey.singleEvent, {
            'eventType': type,
    ...
    emitWaterFillingEvent: function () {
        ACTIVITY_SAVE_A_SITUATION.ref.emitSocketEvent(HDSocketEventType.GAME_MESSAGE, {
            'eventType': ACTIVITY_SAVE_A_SITUATION.socketEvents.START_WATER_FILLING,
        ...
        SocketManager.emitCutomEvent("SingleEvent",
            {
                ...
                'data': {
                    "roomId": HDAppManager.roomId,
                    "roomData": {
                        "activity": ACTIVITY_SAVE_A_SITUATION.ref.config.properties.namespace,
                        "data": dataToSent,
